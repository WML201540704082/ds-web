...
;(function() {
  var resList = {
    ...
    css: [
      // window.SITE_CONFIG.cdnUrl + '/static/css/app.' + window.SITE_CONFIG.version + '.css',
    ],
    js: [
      ...
      // 业务
      window.SITE_CONFIG.cdnUrl + '/static/js/manifest.' + window.SITE_CONFIG.version + '.js',
      window.SITE_CONFIG.cdnUrl + '/static/js/vendor.' + window.SITE_CONFIG.version + '.js',
      window.SITE_CONFIG.cdnUrl + '/static/js/app.' + window.SITE_CONFIG.version + '.js'
    ]
  };
