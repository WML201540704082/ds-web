  ...
  >
    ...
    >
      ...
      <el-form-item label="出库单位" prop="outName">
        <el-input v-model="filterForm.outName" placeholder="请输入出库单位"></el-input>
      </el-form-item>
    ...
    >
      ...
      <el-table-column
        ...
        label="入库时间"
      ></el-table-column>
      <el-table-column prop="orderNo" min-width="160" :show-overflow-tooltip="true" label="入库单号"></el-table-column>
      <el-table-column prop="outName" min-width="160" :show-overflow-tooltip="true" label="出库单位"></el-table-column>
      <el-table-column prop="species" min-width="100" :show-overflow-tooltip="true" label="商品种类"></el-table-column>
      <!-- <el-table-column prop="amount" min-width="120" :show-overflow-tooltip="true" label="商品数量"></el-table-column> -->
      <el-table-column prop="inStockUser" min-width="180" :show-overflow-tooltip="true" label="操作人">
        <template slot-scope="scope">
...
export default {
  ...
  methods: {
    ...
    async getDataList() {
      ...
      const { data } = await api.getinStockFinishList({
        size: this.pageSize,
        ...
        this.$nextTick(() => {
          if (this.selectedList && this.selectedList.length > 0) {
            this.selectedList.forEach((row) => {
              const currentRow = this.dataList.find(
                (item) => item.id == row.id
              );
              if (currentRow) {
