  ...
  <div class="mod-store page-salesFlow-list">
    ...
    <el-card class="mode-store-table">
      <div class="toptitle">
        ...
        <span class="tip" v-if="storeType == 'NEW_RETAIL_AND_DRINK' || storeType == 'NEW_RETAIL'">散称类销量：{{details.weight}}kg</span>        <span class="tip">销售额：{{this.priceNum(details.saleSum)}}元</span>
        <gt-border-button style="float:right;" type="export" txt="下载查询结果" @click.native="() => exportExcel()"/>
      </div>
      <el-table
        :data="dataList"
        border
...
import { paymentOfMode,salesType,orderType,productHaveBulkType } from '@/utils/dict'
