<template>
  <section class="page-goods-brand mod-store">
    <el-card>
      <!-- 查询条件 -->
      <el-form :inline="true" class="mode-form-line1" label-width="60px" ref="filterForm" :model="filterForm" @keyup.enter.native="resetForm('search')">
    ...
    <el-card class="mode-store-table">
      <gt-border-button type="create" @click.native="() => addOrUpdateHandle()" style="float: left;"/>
      <!-- table列表 -->
      <el-table
        :data="dataList"
        border
