    ...
    <div class="prizeContent">
      ...
      <div class="backgrounds">
        ...
        <div class="gifts colorCommon">参与条件：
          ...
          <div class="colorCommon leftsTop" v-if="activeadd.radio == 2">成功分享一次活动给微信好友，可额外获赠抽奖{{activeadd.gift}}次</div>
          <div class="colorCommon leftsTop" v-if="activeadd.radio == 2">每位用户最多可获赠抽奖{{activeadd.share}}次</div>
        </div>
