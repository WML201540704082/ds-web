  ...
  <el-dialog
    ...
    <el-form ref="addSupplier" label-width="120px" :model="addSupplier" :rules="newSupplierRules">
      <el-form-item label="供应商名称" prop="name">
        <el-input v-model="addSupplier.name" :maxlength="30"></el-input>
      </el-form-item>
      <el-form-item label="联系人" prop="linkName">
        <el-input v-model="addSupplier.linkName" :maxlength="10"></el-input>
      </el-form-item>
...
export default {
  data() {
    ...
    return {
      ...
      newSupplierRules:{
        name:[{required:true,message:'请输入有效的供应商名称',trigger:'blur'}],
        linkName:[{required:true,message:'请输入有效的联系人',trigger:'blur'}],
