  ...
  <el-dialog
    ...
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" label-width="100px">
      ...
      <el-form-item label="新密码" prop="newPassword" class="gt-input-tip">
        <el-input v-model="dataForm.newPassword"><span slot="prefix" style="left: 210px;">*字母数字混合的组合，大于6位</span></el-input>
      </el-form-item>
      <el-form-item label="确认密码" prop="verifyNewPassword" class="gt-input-tip">
        <el-input id="pass" v-model="dataForm.verifyNewPassword"><span slot="prefix" style="left: 210px;">*字母数字混合的组合，大于6位</span></el-input>
      </el-form-item>
    </el-form>
    <div class="gt-form-bottom-submit gt-sub">
...
.dialogFind {
  ...
  .el-dialog .el-dialog__header .el-dialog__title {
      color: #F7BE19!important;
  }
  .commenButton {
     background: #F7BE19!important;
  }
  .gt-sub {
    .gt-button.large{
      background: #F7BE19!important;
