<template>
  <div class="mod-store page-shortmessage-setting">
    ...
    <el-form :inline="true" class="mode-form-line1" ref="shortmessage" label-width="120px" :model="shortmessage" @keyup.enter.native="resetForm('search')">
      <el-row>
        ...
        <el-col :span="6">
          ...
          <el-button class="btn-big" type="primary" @click="chooseCoupon">选择优惠券</el-button>
    ...
    <div class="control">
      ...
      <div class="tip">
        本次共发送<span class="blue">{{shortmessage.customerList ? shortmessage.customerList.length : 0}}</span>位顾客，
  ...
  methods: {
    ...
    async getCustomerList(filter) {
      ...
      let formData = {
        ...
        storeId: filter.stores.id ? filter.stores.id : null
        // 顾客生日-宝宝生日
      }
