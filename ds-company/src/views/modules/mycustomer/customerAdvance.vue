<template>
  <div class="mod-store customers">
      ...
      <el-form :model="customer" label-width="120px" :inline="true" ref='customer' class="mode-form-line1" @keyup.enter.native="resetForm('seach')">
        ...
        <el-form-item label="注册来源" prop="storeId">
          <el-select v-model="customer.storeId" filterable placeholder="请选择注册来源" clearable>
            <el-option  label="全部" value="" ></el-option>
            <el-option  label="企业总部" value="企业总部" ></el-option>
            <el-option
        ...
        <el-form-item label="加入时间">
          <gt-time-range
            ...
            :start-time-value="customer.beginTime"
            :end-time-value="customer.endTime"
            end-time-prop="endTime"
            @changeStartValue="value => customer.beginTime = value"
            @changeEndValue="value => customer.endTime = value"
          ></gt-time-range>
        </el-form-item>
          ...
          <div>
            <el-form-item label="顾客标签" prop="tagSelect" class="tagselects">
              ...
              <div class="tagSearchBox" v-if="tagFlag">
                ...
                <div v-else class="emptyTag">没有匹配到您搜索的标签</div>
...
<script>
import { customerLevel, customerBind,customerBirthday,customerReturn,life,customerBuy,babyAges } from '@/utils/dict'
...
export default {
  ...
  created () {
    ...
    this.customer.lifeLevel = this.lifes || null
    // 获取标签列表
    this.getTagList()
    this.getMemberList()
    this.getDetail()
