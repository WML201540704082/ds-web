...
import { orderType,exchangeType,exchangeStatus } from '@/utils/dict'
...
export default {
  ...
  methods: {
    ...
    //     exchangeType: this.order.exchangeType || null,
    //     orderSource: this.order.orderSource || null,
    //     orderStatus: this.order.orderStatus || null,
    //     size: 10000,
    //     page: 0
    //   })
    //   fileDownload(data, '兑换订单列表.xls')
    // },
