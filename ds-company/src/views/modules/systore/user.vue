  ...
  <div class="mod-store mod-user sysItems">
    <el-card>
      <el-form :inline="true" :model="dataForm" @keyup.enter.native="reset('search')">
        ...
        <el-form-item style="margin-bottom: 0;" v-if="isAuth('systore:company:company:select')">
        ...
        <el-form-item class="search-toolbar" v-if="isAuth('store:sysUser:list')">
    ...
    <el-card class="mode-store-table">
      <gt-border-button class="gt-table-create" type="create" v-if="isAuth('store:sysUser:add')" @click.native="addOrUpdateHandle()"/>
      <el-table
        v-table-height
        :data="dataList"
        border
        ...
        <el-table-column
          ...
          align="center"
          width="80"
          v-if="isAuth('store:sysUser:update')"
          label="操作">
          <template slot-scope="scope">
            <el-button style="padding: 0!important;" type="text" :disabled="scope.row.isAdmin === 1" size="small" @click="addOrUpdateHandle(scope.row.id)">修改</el-button>
          </template>
        </el-table-column>
        <el-table-column
          prop="userName"
