...
;(function () {
  ...
  // api接口请求地址
  window.SITE_CONFIG['baseUrl'] = 'https://ds.mengbaige.com'
  // 企业域名
  window.SITE_CONFIG['companyUrl'] = 'https://company.mengbaige.com'
  // 妈咪全知道-生产
  window.SITE_CONFIG['mmqzdUrl'] = 'https://gdmp.gateon.cn'
  // 品牌活动dmp
  window.SITE_CONFIG['gtDmpUrl'] = 'https://gdmp.gateon.cn'
  // 门店域名
  window.SITE_CONFIG['storeUrl'] = 'https://store.mengbaige.com'
  // pos域名
  window.SITE_CONFIG['posUrl'] = 'https://pos.mengbaige.com'
  // ipad适配
  window.SITE_CONFIG['ipadposUrl'] = 'http://ipadpos.mengbaige.com'
  // 商品模板地址
  ...
  // http://192.168.16.180:8080/#/pageHome  安装在测试机上 肖晶的项目地址 便于开发
  // http://192.168.16.190:84/pos/#/pageHome  测试环境地址
  // http://pos.gateon.cn/#/pageHome 外网的地址
