...
;(function () {
  ...
  // 企业域名
  window.SITE_CONFIG['companyUrl'] = 'http://companytest.mengbaige.com'
  // 妈咪全知道-测试
  window.SITE_CONFIG['mmqzdUrl'] = 'https://gdmppre.gateon.cn'
  // 品牌活动dmp
  window.SITE_CONFIG['gtDmpUrl'] = 'https://gdmppre.gateon.cn'
  // 门店域名
  window.SITE_CONFIG['storeUrl'] = 'http://companytest.mengbaige.com/store'
  // pos域名
  window.SITE_CONFIG['posUrl'] = 'http://postest.mengbaige.com'
  // ipad适配
  window.SITE_CONFIG['ipadposUrl'] = 'http://ipadpostest.mengbaige.com'
  // 商品模板地址
